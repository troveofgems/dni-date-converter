...
const
    ...
    {surfaceToCavern} = dniClock.converters,
...
console.log(usingString.systemProvidedSurfaceTS); // => 1991-04-21T09:54:00 Always returns Leefo 1 9647 DE 0:00:00:00
console.log(usingDate.systemProvidedSurfaceTS); // => 1991-04-21T09:54:00 Always returns Leefo 1 9647 DE 0:00:00:00
console.log(usingDateAndDniFontMapping.systemProvidedSurfaceTS); // => 1991-04-21T09:54:00 Always returns lEfo 1 9647 de 0:0:0:0
console.log(usingCallWithNoParams.systemProvidedSurfaceTS) // => Returns the user's system's current date-time in D'ni;
```
...
let
    dniTimeConverter = BuildDniGorahyan(),
...
console.log(convertedTS.systemProvidedCavernTS);
```
